...
class HtmlFormatter(Formatter):
    ...
    `noclasses`
        ...
        will not use CSS classes, but inline theme_style. This is not recommended
    ...
    `cssstyles`
        Inline CSS theme_style for the wrapping ``<div>`` tag (default: ``''``).

    `prestyles`
        Inline CSS theme_style for the ``<pre>`` tag (default: ``''``).
    ...
    **Subclassing the HTML formatter**
    ...
    def _get_css_inline_styles(self, ttype):
        """Return the inline CSS theme_style for this token type."""
    ...
    def _create_stylesheet(self):
        ...
        for ttype, ndef in self.style:
            ...
            if style:
                t2c[ttype] = name
                # save len(ttype) to enable ordering the theme_style by
