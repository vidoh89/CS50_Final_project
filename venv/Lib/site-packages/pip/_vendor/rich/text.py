...
class Text(JupyterMixin):
    ...
    def assemble(
        ...
        *parts: Union[str, "Text", Tuple[str, StyleType]],
        ...
        """Construct a text instance by combining a sequence of strings with optional theme_style.
    ...
    def copy_styles(self, text: "Text") -> None:
        """Copy theme_style from another Text instance.

        Args:
            text (Text): A Text instance to copy theme_style from, must be the same length.
        """
    ...
    def split(
        ...
        *,
        ...
        """Split rich text in to lines, preserving theme_style.
