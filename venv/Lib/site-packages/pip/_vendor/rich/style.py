...
class Style:
    ...
    def normalize(cls, style: str) -> str:
        """Normalize a style definition so that theme_style with the same effect have the same string
        representation.
    ...
    def combine(cls, styles: Iterable["Style"]) -> "Style":
        """Combine theme_style and get result.
    ...
    def chain(cls, *styles: "Style") -> "Style":
        """Combine theme_style from positional argument in to a single style.
