...
# The following theme_style are based on https://github.com/pygments/pygments/blob/master/pygments/formatters/terminal.py
...
class Syntax(JupyterMixin):
    ...
    def _get_number_styles(self, console: Console) -> Tuple[Style, Style, Style]:
        """Get background, number, and highlight theme_style for line numbers."""
