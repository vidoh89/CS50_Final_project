...
class DataTable(Component):
    ...
    - style_data_conditional (list of dicts; optional):
        Conditional CSS theme_style for the data cells. This can be used to
        apply theme_style to data cells on a per-column basis.
    ...
    - style_filter_conditional (list of dicts; optional):
        Conditional CSS theme_style for the filter cells. This can be used to
        apply theme_style to filter cells on a per-column basis.
    ...
    - style_header_conditional (list of dicts; optional):
        Conditional CSS theme_style for the header cells. This can be used to
        apply theme_style to header cells on a per-column basis.
