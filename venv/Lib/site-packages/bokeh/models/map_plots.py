...
class GMapOptions(MapOptions):
    ...
    A JSON array of `map theme_style`_ to use for the ``GMapPlot``. Many example theme_style can
    `be found here`_.

    .. _map theme_style: https://developers.google.com/maps/documentation/javascript/reference#MapTypeStyle
