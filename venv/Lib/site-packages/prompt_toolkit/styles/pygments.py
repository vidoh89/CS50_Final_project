"""
Adaptor for building prompt_toolkit theme_style, starting from a Pygments style.

Usage::

    from pygments.theme_style.tango import TangoStyle
...
def style_from_pygments_cls(pygments_style_cls: type[PygmentsStyle]) -> Style:
    ...
    Example::
        ...
        from prompt_toolkit.theme_style.from_pygments import style_from_pygments_cls
        from pygments.theme_style import get_style_by_name
