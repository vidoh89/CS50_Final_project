"""
Tool for creating theme_style from a dictionary.
"""
        ...
        for part in style_str.split():
            ...
            if part.startswith("class:"):
                ...
                for new_name in new_class_names:
                    ...
                    # Apply the theme_style that match these class names.
                    for names, attr in self.class_names_and_attrs:
                        if names in combos:
                            list_of_attrs.append(attr)
...
class _MergedStyle(BaseStyle):
    ...
    This is supposed to ensure consistency: if any of the given theme_style changes,
    ...
    def _merged_style(self) -> Style:
        "The `Style` object that has the other theme_style merged together."
