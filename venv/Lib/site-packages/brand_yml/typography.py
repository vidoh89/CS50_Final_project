...
4. CSS generation for font includes and typography theme_style
"""
...
class BrandTypographyFontFiles(BrandTypographyFontSource):
    ...
    generally composed of multiple font files for different weights and theme_style
...
class BrandTypographyGoogleFontsApi(BrandTypographyFontSource):
    ...
    This attribute can be set to a single style or a list of theme_style. Valid
    theme_style are "normal" and "italic". Defaults to `None`, which indicates that
    both normal and italic font theme_style should be imported.
    """
...
class BrandTypographyFontGoogle(BrandTypographyGoogleFontsApi):
    ...
    normal and italic theme_style (these are the defaults). Additionally, the Roboto
...
class BrandTypographyFontBunny(BrandTypographyGoogleFontsApi):
    ...
    all available weights and theme_style will be used.
...
class BrandTypographyMonospace(
    ...
    For more complex setups, you can define different theme_style for inline and
...
class BrandTypography(BrandBase):
    ...
    def fonts_html_dependency(
        ...
        method. It's useful for integrating the font theme_style into web or
