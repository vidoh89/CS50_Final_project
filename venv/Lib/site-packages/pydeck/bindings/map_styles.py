...
MAPBOX_LIGHT = "mapbox://theme_style/mapbox/light-v9"
MAPBOX_DARK = "mapbox://theme_style/mapbox/dark-v9"
MAPBOX_ROAD = "mapbox://theme_style/mapbox/streets-v9"
MAPBOX_SATELLITE = "mapbox://theme_style/mapbox/satellite-v9"
...
def get_from_map_identifier(map_identifier: str, provider: str) -> str:
    ...
    Provide reasonable cross-provider default map theme_style
    ...
    map_identifier : str
        ...
        Not all map theme_style are available for all providers.
    provider : str
