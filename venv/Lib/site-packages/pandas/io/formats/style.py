...
class Styler(StylerRenderer):
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def concat(self, other: Styler) -> Styler:
        ...
        The following should be noted:
          ...
          - ``css`` will be inherited from the original Styler, and the value of
            ...
            ``foot0_``. If more concats are chained, their theme_style will be prepended
    ...
    def to_latex(
        ...
        *,
        ...
        convert_css : bool, default False
            Convert simple cell-theme_style from CSS to LaTeX format. Any CSS not found in
        ...
        **Table Styles**
        ...
        input arguments. These arguments are added to table theme_style in the format:
        ...
        If other ``commands`` are added to table theme_style they will be detected, and
        ...
        **CSS Conversion**
        ...
        It is also possible to add user-defined LaTeX only theme_style to a HTML-CSS Styler
        ...
        Thirdly we will apply some (CSS-HTML) theme_style to our object. We will use a
        ...
        All the above theme_style will work with HTML (see below) and LaTeX upon conversion:
    ...
    def set_td_classes(self, classes: DataFrame) -> Styler:
        ...
        See Also
        --------
        Styler.set_table_styles: Set the table theme_style included within the ``<style>``
            HTML element.
    ...
    def _copy(self, deepcopy: bool = False) -> Styler:
        ...
        data and theme_style as the original.
    ...
    def clear(self) -> None:
        """
        Reset the ``Styler``, removing any previously applied theme_style.
    ...
    def apply(
        ...
        **kwargs : dict
        ...
        Notes
        -----
        The elements of the output of ``func`` should be CSS theme_style as strings, in the
    ...
    @doc(
        ...
        output_note="an identically sized array of CSS theme_style as strings",
        var="s",
    ...
    @doc(
        ...
        output_note="CSS theme_style as a string",
        var="v",
    ...
    def export(self) -> dict[str, Any]:
        """
        Export the theme_style applied to the current Styler.
        ...
        See Also
        --------
        Styler.use: Set the theme_style on the current Styler.
    ...
    def use(self, styles: dict[str, Any]) -> Styler:
        """
        Set the theme_style on the current Styler.

        Possibly uses theme_style from ``Styler.export``.
    ...
    def set_table_styles(
        ...
        """
        Set the table theme_style included within the ``<style>`` HTML element.
        ...
        overwrite : bool, default True
            ...
            rules are preserved so most recent theme_style set will dominate
    ...
    # -----------------------------------------------------------------------
    # A collection of "builtin" theme_style
    # -----------------------------------------------------------------------
