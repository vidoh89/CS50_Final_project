...
class CSSToExcelConverter:
    """
    A callable for converting CSS declarations to ExcelWriter theme_style

    Supports parts of CSS 2.2, with minimal CSS 3.0 support (e.g. text-shadow),
    focusing on font styling, backgrounds, borders and alignment.

    Operates by first computing CSS theme_style in a fairly generic
    ...
    def _border_style(self, style: str | None, width: str | None, color: str | None):
        # convert theme_style and widths to openxml, one of:
        #       'dashDot'
        #       'dashDotDot'
        #       'dashed'
        #       'dotted'
...
class ExcelFormatter:
    ...
    style_converter : callable, optional
        This translates Styler theme_style (CSS) into ExcelWriter theme_style.
    ...
    def __init__(
        ...
        if not isinstance(df, DataFrame):
            self.styler = df
            self.styler._compute()  # calculate applied theme_style
            df = df.data
