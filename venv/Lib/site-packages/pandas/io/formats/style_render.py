...
class StylerRenderer:
    ...
    def _render(
        ...
        """
        Computes and applies theme_style and then generates the general render dicts.
    ...
    def _render_html(
        ...
        **kwargs,
        ...
        """
        Renders the ``Styler`` including all applied theme_style to HTML.
    ...
    def _compute(self):
        ...
        .apply or .map. The append theme_style to apply as tuples of
    ...
    def _translate(
        ...
        }  # add the cell_ids theme_style map to the render dictionary in right format
    ...
    def _translate_latex(self, d: dict, clines: str | None) -> None:
        ...
        for r, row in zip(concatenated_visible_rows(self), d["body"]):
            ...
            # with the ctx obj which contains the cell theme_style.
...
class Tooltips:
    ...
    def _pseudo_css(self, uuid: str, name: str, row: int, col: int, text: str):
        ...
        <td> element id which are added to overall table theme_style:
    ...
    def _translate(self, styler: StylerRenderer, d: dict):
        ...
        - Add ``<span>`` HTML element to each data cells ``display_value``. Ignores
          headers.
        - Add table level CSS theme_style to control pseudo classes.
...
def _parse_latex_cell_styles(
    ...
    The most recent style forms the inner component, for example for theme_style:
