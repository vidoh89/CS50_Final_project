...
class DataGrid(AbstractTabularData, Generic[IntoDataFrameT]):
    ...
    styles
        ...
        style info objects can be used to apply CSS theme_style to the data frame. If
        `theme_style=None`, no styling will be applied.
        ...
        res: FrameJson = {
            **serialize_frame(self.data),
            "options": {
                ...
                "theme_style": as_browser_style_infos(
                    self.styles,
                    into_data=self.data,
                ),
            },
