...
class data_frame(
    ...
    * :class:`~shiny.render.DataGrid` and :class:`~shiny.render.DataTable` are the
    ...
    def _init_reactives(self) -> None:
        ...
        # Update the theme_style any time the cell patch map or new data updates
        ...
        @reactive.event(
            ...
            # The theme_style are being sent with the initial blob.
            ignore_init=True,
        )
        async def _():
...
# GT theme_style are eager! THis causes issues with dynamic style locations
# Need to track movement of columns

# SKIP!: ONLY SUPPORT GT and editable==False; Sprint for next 24 hrs!

# THIS v1 release;
# * theme_style= Callable[[data], Styles] | Styles
# * theme_style function will return json format which is
...
# * Call theme_style fn after each edit (and on init); Send full theme_style for each cell
