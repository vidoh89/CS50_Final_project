...
def get_markerstyle_from_collection(props):
    markerstyle = dict(
        alpha=None,
        facecolor=convert_rgba_array(props["theme_style"]["facecolor"]),
        marker=convert_path_array(props["paths"]),
        edgewidth=convert_linewidth_array(props["theme_style"]["linewidth"]),
        # markersize=convert_size_array(props['theme_style']['size']),  # TODO!
        markersize=convert_size_array(props["mplobj"].get_sizes()),
        edgecolor=convert_rgba_array(props["theme_style"]["edgecolor"]),
    )
    return markerstyle
