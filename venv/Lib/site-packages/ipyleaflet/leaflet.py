...
class WMSLayer(TileLayer):
    ...
    styles: string, default ""
        Comma-separated list of WMS theme_style
...
class VectorTileLayer(Layer):
    ...
    layer_styles: dict or string, default {}. If string, it will be parsed as a javascript object (useful for defining theme_style that depend on properties and/or zoom).
