...
class AxisConfigKwds(TypedDict, total=False):
    ...
    position
        ...
        **Default value**: ``0``
    style
        A string or array of strings indicating the name of custom theme_style to apply to the
        ...
        style is an array, later theme_style will override earlier theme_style.
...
class ConfigKwds(TypedDict, total=False):
    ...
    fieldTitle
        Defines how Vega-Lite generates title for fields. There are three possible theme_style:
    ...
    style
        ...
        theme_style names; the values have to be valid `mark configuration objects
...
class OverlayMarkDefKwds(TypedDict, total=False):
    ...
    style
        ...
        array, later theme_style will override earlier theme_style. Any `mark properties
...
class ViewBackgroundKwds(TypedDict, total=False):
    ...
    style
        ...
        <https://vega.github.io/vega-lite/docs/mark.html#style-config>`__. If style is an
        array, later theme_style will override earlier theme_style.
